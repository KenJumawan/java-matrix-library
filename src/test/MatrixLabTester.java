...
/**
 * A workbench for testing MatrixLab.
...
public class MatrixLabTester {
    ...
    public static void printUsage(int exitCode) {
        MatrixTestSuite suite = MatrixTestSuite.getInstance();

        System.out.println("Usage: MatrixLabTester [n]");
