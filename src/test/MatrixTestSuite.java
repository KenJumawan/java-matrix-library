...
public class MatrixTestSuite {
     ...
     */
    private static MatrixTestSuite instance = null;
     ...
     */
    public static MatrixTestSuite getInstance() {
        if (instance == null)
            instance = new MatrixTestSuite();
        return instance;
    }
    ...
    private static List<TestCase> generateTestCases() {
        ...
        testCases.add(new TestCase("AddBasic", MatrixTestMethods::addBasicTest));
        testCases.add(new TestCase("AddDimensionMismatch", MatrixTestMethods::addDimensionMismatchTest));
        // STUDENTS: Additional tests may go here, if desired.
        // This time, I'd really suggest adding some!
    ...
    public int getIndex(TestCase testCase) {
        ...
        for (int i = 0; i < testCases.size(); i++)
            if (testCases.get(i).getName().equals(name))
                return i;
